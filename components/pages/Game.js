...
export default class Game extends Component {
    ...
    onStrokeEnd(){
        ...
        if(start >= 175 && start <=200 && end>=150 && end<=200 ){
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <ImageBackground source={{uri: "http://goldenfuturelife.in/tradeGame/assets/uploads/users/2019-06-01_(2).png"}} style={{width: '100%', height: "100%" , marginTop:5 }}>
          <RNSketchCanvas
          ...
          />
          {this.state.nextGame &&
             <Button block light style={styles.marginTB10} onPress={() => this.props.navigation.navigate('Game3')}>
                <Text>Next Stap</Text>
            </Button>
          }
          </ImageBackground>

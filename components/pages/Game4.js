...
export default class Game4 extends Component {
    ...
    onStrokeEnd(){
        ...
        if(start >= 450 && start <=480 && end>=310 && end<=340 && middle){
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <ImageBackground source={{uri: "http://goldenfuturelife.in/tradeGame/assets/uploads/users/2019-06-01_(3).png"}} style={{width: '100%', height: "100%" , marginTop:5 }}>
          <RNSketchCanvas
          ...
          />
          {this.state.nextGame &&
             <Button block light style={styles.marginTB10} onPress={() => this.props.navigation.navigate('Game5')}>
                <Text>Next Stap</Text>
            </Button>
          }
          </ImageBackground>
